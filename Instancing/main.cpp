...
int main(int argc, char **argv)
{
    ...
    diffuseNormalMat->SetTexture((char*)"diffuseMap", new Texture((char*)"../Assets/iron_buckler_diffuse.png"));
    Texture* texNorm = new Texture((char*)"../Assets/iron_buckler_normal.png");
    diffuseNormalMat->SetTexture((char*)"normalMap", texNorm);
	...
	while (!glfwWindowShouldClose(window))
	{
        ...
        skyMat->SetMatrix((char*)"cameraView", viewRotation);
